...
You can watch and follow along with a live coding video for this chapter here: <https://youtu.be/L7J2mJrl33k>
...
### TESTING...Which is a valid ggplot statement?

`r longmcq(c( answer="ggplot(mydata, c(x = date, y = flow)) + geom_line()",  "ggplot(mydata, c(x = date, y = flow)), geom_line()",  "ggplot(mydata c(x = date, y = flow)) + geom_line()", "ggplot(mydata, c(x = date y = flow)) + geom_line()"))`
